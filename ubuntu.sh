sudo -i
# Proxy and No_Proxy variables set up

echo "no_proxy=169.254.169.254,127.0.0.1" >> /etc/environment
echo "http_proxy=http://zscaler.atom.ads:9480/" >> /etc/environment
echo "https_proxy=http://zscaler.atom.ads:9480/" >> /etc/environment

# Proxy APT UPDATE  run

sudo apt update -y

# Proxy APT UPGRADE  run
sudo apt upgrade -y
